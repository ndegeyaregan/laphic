...
jQuery(function ($) {
  ...
  if ($("#map").length > 0) {
    ...
    var contactmap = {
      lat: 0.4339754, // Adjust the latitude for Kampala
      lng: 31.9021621, // Adjust the longitude for Kampala
    };
    ...
    $("#map")
      ...
      .infowindow({
        position: contactmap,
        content: "Kampala, Uganda", // Adjust the content to your preference
      })
